...
IRTREE=IRTree/Expression.cpp IRTree/Statement.cpp IRTree/SubTreeWrapper.cpp IRTree/Translator.cpp IRTree/IRPrinter.cpp IRTree/canonizers/CallCanon.cpp IRTree/canonizers/ESeqCanon.cpp IRTree/Label.cpp IRTree/canonizers/Linearizer.cpp
