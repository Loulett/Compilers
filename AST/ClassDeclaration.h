...
public:
	ClassDeclaration(int first_line, int first_column, IIdentifier* class_name, IIdentifier* extends_class_name, std::vector<std::unique_ptr<IVarDeclaration>>* vars, std::vector<std::unique_ptr<IMethodDeclaration>>* methods);
